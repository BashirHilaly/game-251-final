...
import IndustryWarehouseFloor from '../../dist/assets/IndustryWarehouseFloor.jpg';
import woodTextures from '../../dist/assets/WoodTextures.jpg';
import enemy2img from '../../dist/assets/pests/lvl1_pest2.png';
...
class Level2 extends Phaser.Scene
{
    ...
    preload ()
    {
        ...
        this.load.image('IndustryWarehouseFloor', IndustryWarehouseFloor);
        this.load.image('woodTextures', woodTextures);

        this.load.image('enemy2img', enemy2img);
    }
    ...
    endRound ()
    {
        if (!this.player.isDead){
            ...
            this.gameOver = true;
            this.physics.pause();
            this.ui.roundEnd(this.amountOfEnemies-this.enemies.length, this.amountOfEnemies, this.nextLevelKey, 'Level2');
    ...
    create ()
    {
        ...
        let background = this.add.image(0, 0, 'IndustryWarehouseFloor');
    ...
    update ()
    {
        ...
        // Update timer text
        if (!this.player.isDead && this.ui != null){
